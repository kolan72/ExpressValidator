...
namespace ExpressValidator.Tests.Net8
{
	...
	public class ConfigurablePropertyValidatorBuilderTests
	{
		...
		public void Should_HaveCorrectErrorMessage_When_CatsCount_IsInvalid()
		{
			...
			var person = new Person
			{
				Cats = new List<Cat>(), // 0 cats - below minimum
				Id = 0
			};
			var validator = new PersonValidator();
		...
		public void Should_Fail_When_BothCatsAndId_AreInvalid()
		{
			...
			var person = new Person
			{
				Cats = new List<Cat>(), // 0 cats - invalid
		...
		public void Should_Fail_When_OnlyId_IsInvalid()
		{
			...
			var person = new Person
			{
				Cats = new List<Cat> { new Cat(), new Cat() }, // Valid
				Id = 10 // Invalid
			};
			var validator = new PersonValidator();
		...
		{
			// Arrange
			var person1 = new Person { Cats = new List<Cat> { new Cat() }, Id = 0 };
			var person2 = new Person { Cats = new List<Cat>(), Id = 10 };
			var validator = new PersonValidator();
		...
		public void Should_ValidateCatsCount_Property()
		{
			...
			var person = new Person
			{
				Cats = new List<Cat> { new Cat(), new Cat() }, // Count = 2
				Id = 0
			};
			var validator = new PersonValidator();
		...
		public void Should_ValidatePerson_WithMinimumValidCats()
		{
			...
			var person = new Person
			{
				Cats = new List<Cat> { new Cat() }, // Exactly 1 cat (minimum)
				Id = -1
			};
			var validator = new PersonValidator();
